...
PATH_POPULARITY = '/app/data/popularity_iw.csv'
PATH_TAXONOMY = '/app/data/taxonomy_iw.csv'

PATH_POPULARITY_TEMP = '/app/data/popularity_iw_temp.csv'
PATH_TAXONOMY_TEMP = '/app/data/taxonomy_iw_temp.csv'

PATH_POPULARITY_PROCESSED = '/app/data/nodes.csv'
PATH_TAXONOMY_PROCESSED = '/app/data/edges.csv'
